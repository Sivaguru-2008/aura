...
Each reader implements :class:`~aura.backend.foundation.mri.io.base.StudyReader` and does
...
* :mod:`~aura.backend.foundation.mri.io.dicom_reader` — pydicom (already a dependency of
  the modality router).
* :mod:`~aura.backend.foundation.mri.io.nifti_reader` — NIfTI-1 and NIfTI-2, implemented
...
* :mod:`~aura.backend.foundation.mri.io.nrrd_reader` — NRRD, likewise implemented against
